...
public class PetService {
    ...
    public void save(Pet pet) {
        ...
        if (pet.getSpecies() == null || pet.getSpecies().isBlank()) {
            throw new AttributeValidationException("O campo 'Espécie' precisa ser preenchido");
        }
        ...
        if (pet.getContato().length() != 11){
            throw new AttributeValidationException("O campo 'Contato' precisa conter 11 digitos considerando o DD. Ex.: 11999999999");
        }
        pets.add(pet);
    }
